...
require 'lib/droplet_raiser'

describe DropletRaiser do
  ...
  subject{ DropletRaiser.new(droplet_id, do_caller, FakeLogger) }

  before do
    do_caller.expect(:power_droplet_on, action_details_body, [ droplet_id ])
  end
